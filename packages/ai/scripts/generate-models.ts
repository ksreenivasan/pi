...
async function generateModels() {
	...
	// Older model limits are based on observed server behavior. Keep Codex high by default for long coding
	// sessions; this fork pins the GPT-5.6/GPT-6 context limits to 512k (upstream tracks Codex's 272k default
	// catalog limit).
	const CODEX_BASE_URL = "https://chatgpt.com/backend-api";
	const CODEX_CONTEXT = 512000;
	const CODEX_GPT_56_CONTEXT = 512000;
